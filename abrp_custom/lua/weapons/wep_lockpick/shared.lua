...
SWEP.Instructions = "Left or right click to pick a door, fading door, or elevator."
SWEP.Contact = ""
SWEP.Purpose = ""
...
function SWEP:PrimaryAttack()
    ...
    local endDelta = hook.Call("lockpickTime", nil, self:GetOwner(), ent) or util.SharedRandom("DarkRP_Lockpick" .. self:EntIndex() .. "_" .. self:GetTotalLockpicks(), 10, 12)
