...
function AntiCrash.Pong( um )
	...
	AntiCrash.LastMoveTime = CurTime() + 50
...
function AntiCrash.ServerCrash()
	...
	dlabel:SetPos(30 , 30)
	dlabel:SetSize(190 , 25)
	dlabel:SetText(string.format("Auto-Reconnect in %d seconds!" , retrytime - CurTime()))
	...
	dbutton:SetPos(5 , 65)
	dbutton:SetSize(190 , 30)
	dbutton:SetText("Force Reconnect")
