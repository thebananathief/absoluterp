...
function ENT:Draw()
    ...
    textAng:RotateAroundAxis(textAng:Forward(), 90)
		...
		cam.Start3D2D(Pos, textAng, 0.02)
					...
					draw.DrawText("Universal Ammo Crate", "Calibri128_blur", 0, -130 + (110 * 2), Color(0, 0, 0, alpha), TEXT_ALIGN_CENTER)
					draw.DrawText("Universal Ammo Crate", "Calibri128", 0, -130 + (110 * 2), Color(255, 255, 255, alpha), TEXT_ALIGN_CENTER)
					...
					draw.DrawText("Clips Left: "..self:GetNWInt("AmmClip", 10), "Calibri128_blur", 0, -130 + (110 * 3), Color(0, 0, 0, alpha), TEXT_ALIGN_CENTER)
					draw.DrawText("Clips Left: "..self:GetNWInt("AmmClip", 10), "Calibri128", 0, -130 + (110 * 3), Color(255, 255, 255, alpha), TEXT_ALIGN_CENTER)
    cam.End3D2D()
end
